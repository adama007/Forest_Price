...
<table class="table">
  ...
  <?php
    ...
    <tr>
      ...
      <th scope="row"  style="font-size:large;padding-right:30px"><a href="sppressio_art.php?num_art=<?=$result['num_art'];?> "style="color:red;text-decoration:none"><?php echo $result['num_art'];?></a></th>
